...
/* Active chips — MSIT accent red (replaced pinkish/purple) */
.al-chip.active{
  background: var(--t-primary);
  border-color: rgba(201,75,80,.26);
}
html.theme-dark .al-chip.active{
...
/* Highlighted option — MSIT accent red (replaced pinkish/purple) */
