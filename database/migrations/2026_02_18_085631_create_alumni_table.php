...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('alumni', function (Blueprint $table) {
            ...
            // Relations
            $table->unsignedBigInteger('user_id')->nullable()->index()->comment('Link if alumni has a portal account');
            $table->unsignedBigInteger('department_id')->nullable()->index()->comment("Alumni's department/branch");
            ...
            // Content / flags
            $table->longText('note')->nullable()->comment('Alumni intro (public-friendly)');
